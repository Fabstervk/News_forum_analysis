...
input_csv_file = '/workspaces/News_forum_analysis/translated_börrsnack_forum_posts_20240922_122818.csv'  # Update to the correct CSV file
...
output_csv_file = f'/workspaces/News_forum_analysis/translated_börssnack_forum_posts_with_vader_sentiment_{pd.Timestamp.now().strftime("%Y%m%d_%H%M%S")}.csv'
